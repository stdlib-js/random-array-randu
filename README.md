...
```javascript
randu = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-randu@v0.0.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-array-randu@v0.0.1-umd/browser.js"></script>
```
